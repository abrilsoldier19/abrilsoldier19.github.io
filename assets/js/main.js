...
// Función para realizar la operación en opcion iiia)Simulacion Simulacion del calculo de la longitud de la correa que se necesita en mm
    function operacion_iiia() {
          var label_num_longitud1 = parseFloat(document.getElementById('label_num_longitud1').value);
          var label_num_longitud2 = parseFloat(document.getElementById('label_num_longitud2').value);
          var label_num_longitud3 = parseFloat(document.getElementById('label_num_longitud3').value);
    
          var L = Math.PI*(label_num_longitud1 + label_num_longitud2) + 2 * Math.sqrt(Math.pow(label_num_longitud3,2) + Math.pow(label_num_longitud1 - label_num_longitud2, 2));
    
          document.getElementById('resultado').innerHTML = "" + L;
        }
