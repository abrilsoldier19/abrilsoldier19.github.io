...
#Generar grafica de opcion a)
    ...
    buttonExample = Button(filewin, 
                text="Generar grafica",
                command=GenerarGrafica_opcion_iiia)
    buttonExample.config(bg="#DCCFF3", fg="#7000B7")
    buttonExample.pack()
...
constituido por tres escalonamientos en mm""",
    ...
    def ejecutar_operacioniid():
        ...
        resultado = operacioniid(valor_velocidadN1, valor_i)
        label_valor_result.config(text = resultado)
...
#lineas de codigo para crear menu
menubar1 = Menu(root)
...
def help():
    filewin = Toplevel(root)
    filewin.configure(bg="black")
    label_gracias= Label(filewin,font=("a Astro Space",11) ,text="""Si tiene alguna duda, comunicarse con la alumna""", fg="white",bg="black")
    label_gracias.pack()

    label_alumnos= Label(filewin,font=("Lastica",11) ,text="""Abril  Mejia  Rangel
    """, fg="#DBA5F9",bg="black")
    label_alumnos.pack()

    label_correo= Label(filewin,font=("Century Gothic",11) ,text="""avril.rock1471@gmail.com""", fg="#DBA5F9",bg="black")
    label_correo.pack()
